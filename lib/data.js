...
import {
    ...
    RiPrinterLine, RiContrastDrop2Line, RiRouterLine, RiHeadphoneLine, RiChatSmile2Line,
    RiVerifiedBadgeLine, RiTruckLine, RiBankCard2Line, RiPercentLine, RiBox1Line
...
export const localstorage_keys = {
    ...
    wishlist_products: 'wishlist_prod_ids',
};
...
export const nav_categories = [
    ...
    },
    {
        ...
        subcategories: [
            ...
            {
                'title': 'PC Power',
                'slug': 'pc-power-monitor',
            },
            {
                'title': 'Philips',
                'slug': 'philips-monitor',
            },
            {
                'title': 'Real View',
                'slug': 'real-view-monitor',
            },
            {
                'title': 'ValueTop',
                'slug': 'valuetop-monitor',
            },
            {
                'title': 'All Brands',
                'slug': 'monitor',
            ...
            {
                'title': 'FHD Monitor',
                'slug': 'fhd-resolution-monitor',
            },
            {
                'title': '2k Monitor',
                'slug': '2k-qhd-resolution-monitor',
            },
            {
                'title': '4k Monitor',
                'slug': '4k-uhd-resolution-monitor',
            },
            {
                'title': 'IPS Monitor',
                'slug': 'ips-panel-monitor',
            },
            {
                'title': 'OLED Monitor',
                'slug': 'oled-panel-monitor',
            },
            {
                'title': '100Hz Monitor',
                'slug': '100hz-monitor',
...
export const cat_icon_mapping = {
    ...
    smartphone: <SmartphoneIcon className='cat-icon' />,
};

export const key_points = [
    {
        icon: <RiVerifiedBadgeLine size={30} color="white" />,
        title: 'Authentic Product'
    },
    {
        icon: <RiPercentLine size={30} color="white" />,
        title: 'Best Deals'
    },
    {
        icon: <RiTruckLine size={30} color="white" />,
        title: 'Nationwide Delivery'
    },
    {
        icon: <RiBankCard2Line size={30} color="white" />,
        title: 'Flexible EMI Facility'
    },
]


export const marquee_message = `Welcome to HIFI Computer, the largest and most trusted IT solutions provider in Sylhet Division. Browse and purchase from our extensive collection of authentic IT products right here and enjoy unbeatable deals and exceptional service. Visit our showroom today for the best deals and experience exceptional customer service. `;
...
export const api_endpoints = {
    ...
    initiate_wishlist: 'api/initwishlist/',
    sync_wishlist: 'api/syncwishlist/',
...
export const nav_links = [
    {
        title: "Track Order",
        url: "/track-order",
        icon: <RiBox1Line size={18} />
    },
    {
        title: "Contact Us",
        url: "/contact-us",
        icon: <RiChatSmile2Line size={18} />
    }
]

export const mapEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8860.022969569916!2d91.86864107390714!3d24.893466403810418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3751ab2ac907d001%3A0x2b39af18016d0645!2sHiFi%20Computer%3A-Laptop%2CDesktop%2CCCTV%2CPrinter%20Show%20Room!5e0!3m2!1sen!2sbd!4v1742377519956!5m2!1sen!2sbd";
